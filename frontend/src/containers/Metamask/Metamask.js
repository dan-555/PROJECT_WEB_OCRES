...
export default function Metamask() {
  ...
  const fetchData = () => {
    ...
    const ETHBalance = `https://api.etherscan.io/api?module=account&action=balance&address=0x6bC26E853086CF244849D3780eC5C4BF80106410&tag=latest&apikey=35BFWIG7F816FH2RSHCA9YC4UNHM1EXRF4`;
...
fetchData();     
    ...
    return (
        ...
        <div>
            ...
            <MetamDatas dataBalance={data} dataGas={dataGas}  dataTime={dataTime}/>
